...
public class ClusterManagerModule {
    ...
    public static class Builder {
        ...
        @java.beans.ConstructorProperties({ "id", "tags", "useLocal", "discovery", "protocols",
                                            "topology", "metadataFactory" })
        private Builder(final Optional<UUID> id, final Optional<Map<String, String>> tags,
